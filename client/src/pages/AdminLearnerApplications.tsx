...
export default function AdminLearnerApplications() {
  ...
  const { data: allApplications, refetch: refetchAll } = trpc.learnerApplications.getAll.useQuery(undefined, {
    enabled: isAuthenticated && user?.role === 'admin',
  });

  const updateStatusMutation = trpc.learnerApplications.updateStatus.useMutation({
    onSuccess: () => {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold">Learner Applications</h1>
          </div>
        </div>
                    ...
                    {filteredApplications.map((application) => (
                      <div key={application.id} className="border rounded-lg p-4 flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground mb-1">
                            <strong>Program:</strong> {application.programInterest}
                          </p>
            ...
            {selectedApplication && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label className="text-muted-foreground">Program Interest</Label>
                    <p className="font-medium">{selectedApplication.programInterest}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <Label className="text-muted-foreground">Computer Access</Label>
                    <p className="font-medium">{selectedApplication.computerAccess}</p>
                  </div>
                  <div>
                    <Label className="text-muted-foreground">Internet Access</Label>
                    <p className="font-medium">{selectedApplication.internetAccess}</p>
                  </div>
                  <div className="col-span-2">
                  ...
                  {selectedApplication.hearAboutUs && (
                    <div className="col-span-2">
                      ...
                      <p className="font-medium">{selectedApplication.hearAboutUs}</p>
                    </div>
                  )}
                </div>
