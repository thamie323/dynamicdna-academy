...
import { handleLocalLogin } from "../local-login";
...
async function startServer() {
  ...
  // Adjust path: server/_core -> repo root -> client/public/uploads
  const uploadsDir = path.resolve(__dirname, "..", "..", "client", "public", "uploads");

  // Any request to /uploads/* will serve the file from that folder
  ...
  // Local development login endpoint (only available in development mode)
